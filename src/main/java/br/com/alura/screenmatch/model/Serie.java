...
public class Serie {
    ...
    public Serie(DadosSerie dadosSerie) {
        ...
        //this.sinopse = dadosSerie.sinopse(); //opcao sem traducao da sinopse
        //ASR - 10/07/2025 - Linha abaixo é utilizada para traduzir a Sonopse. Ela esta comentada porque falta a chave de acesso a API do GPT
